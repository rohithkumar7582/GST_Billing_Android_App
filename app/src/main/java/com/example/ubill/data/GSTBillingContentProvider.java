package com.example.ubill.data;
...
import com.example.ubill.NewBillActivity;
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (match){
            case BILL_WITH_ID:
                ...
                if(rowsInserted > 0){
                    Objects.requireNonNull(getContext()).getContentResolver().notifyChange(GSTBillingContract.BASE_CONTENT_URI.buildUpon().appendPath(GSTBillingContract.GSTBillingCustomerEntry.SECONDARY_TABLE_NAME + uri.getLastPathSegment()).build(), null);
                }
                return rowsInserted;
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match){
            case BILL_WITH_ID:
                ...
                if(rowsUpdated > 0){
                    Objects.requireNonNull(getContext()).getContentResolver().notifyChange(GSTBillingContract.GSTBillingEntry.CONTENT_URI, null);
                }
                break;
            case BILL_WITH_ID_WITH_ID:
                ...
                if(rowsUpdated > 0){
                    Objects.requireNonNull(getContext()).getContentResolver().notifyChange(GSTBillingContract.BASE_CONTENT_URI.buildUpon().appendPath(GSTBillingContract.GSTBillingCustomerEntry.SECONDARY_TABLE_NAME + uri.getPathSegments().get(1)).build(), null);
                    getContext().getContentResolver().notifyChange(GSTBillingContract.GSTBillingEntry.CONTENT_URI, null);
                }
                break;
            default:
