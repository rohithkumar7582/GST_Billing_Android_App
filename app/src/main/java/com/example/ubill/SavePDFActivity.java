...
import com.example.ubill.utils.NumberToWord;
import com.example.ubill.utils.PDFUtils;
...
public class SavePDFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        businessNameTv.setText(prefs.getString(CompanyRegister.SETUP_BUSINESS_NAME_KEY, getString(R.string.app_name)));
        businessAddressTv.setText(prefs.getString(CompanyRegister.SETUP_BUSINESS_ADDRESS_KEY, "Address"));
        String authorisedSignatory = "For " + prefs.getString(CompanyRegister.SETUP_BUSINESS_NAME_KEY, getString(R.string.app_name));
        authorisedSignatoryTv.setText(authorisedSignatory);
        businessContactTv.setText(prefs.getString(CompanyRegister.SETUP_BUSINESS_CONTACT_KEY, ""));
